...
const ArcGalleryHero = ({
  ...
  const portfolioItems = [
    ...
    { image: 'https://cdn.poehali.dev/projects/f4fbcbce-665a-43d8-b74a-7833718f15fc/bucket/71a62a83-4529-4f01-8d2a-0ba3d9f088c4.PNG', title: 'Тарифы на эвакуацию', description: 'Страница тарифов с карточками по типу авто — легковые, джипы и спецтехника' },
  ];
